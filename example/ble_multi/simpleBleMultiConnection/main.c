...
*/
#define     LARGE_HEAP_SIZE  (4*1024+512)
...
static void ble_mem_init_config(void)
{
    ...
    #endif
    extern void ll_multi_conn_record_rtc_tick_init(record_rtc_tick* pBuf);
    static record_rtc_tick record_conn_rtc_tick[BLE_MAX_ALLOW_CONNECTION];
    ll_multi_conn_record_rtc_tick_init(record_conn_rtc_tick);
