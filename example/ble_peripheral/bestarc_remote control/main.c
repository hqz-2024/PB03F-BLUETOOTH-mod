...
{
    ioinit_cfg_t ioInit[] = {
        {GPIO_P02, GPIO_FLOATING},  /* SWD IO  */
        {GPIO_P03, GPIO_FLOATING},  /* SWD CLK */
        {GPIO_P09, GPIO_PULL_UP},   /* UART0 TX (DEBUG) */
        {GPIO_P10, GPIO_PULL_UP},   /* UART0 RX (DEBUG) */
        {GPIO_P00, GPIO_PULL_DOWN}, /* P0  PWM 输出 */
        {GPIO_P07, GPIO_PULL_DOWN}, /* P7  红外探头 (外部上拉) */
