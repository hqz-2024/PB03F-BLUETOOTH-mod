...
__ATTR_SECTION_SRAM__ const pTaskEventHandlerFn tasksArr[] =
{
    ...
    GAPBondMgr_ProcessEvent,                                          // task 7, add 2017-11-15
    GATTServApp_ProcessEvent,                                         // task 8

		BYS_BLEControl_Application_ProcessEvent,                          // task 10
		BYS_BLEControl_Dev_ProcessEvent,																	// task 9
...
void osalInitTasks( void )
{
    ...
    /* Application */
    BYS_BLEControl_Application_INIT( taskID++ );
    BYS_BLEControl_Dev_INIT( taskID++ );
}
/**************************************************************************************************
    FUNCTIONS
 **************************************************************************************************/
