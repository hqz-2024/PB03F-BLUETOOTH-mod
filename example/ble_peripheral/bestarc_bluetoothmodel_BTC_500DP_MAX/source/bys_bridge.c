...
void BYS_Bridge_Init(uint8 task_id)
{
    ...
    DevInfo_AddService();
    DevInfo_SetParameter(DEVINFO_MODEL_NUMBER,      g_bys_model_name_len,  (void *)g_bys_model_name);
    ...
    advertData[ADV_DEV_TYPE_OFFSET]     = LO_UINT16(g_bys_model_dev_type);
    advertData[ADV_DEV_TYPE_OFFSET + 1] = HI_UINT16(g_bys_model_dev_type);
