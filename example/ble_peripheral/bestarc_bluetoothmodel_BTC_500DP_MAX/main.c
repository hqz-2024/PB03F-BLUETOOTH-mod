...
#if (BTC_500DP_MODEL == BTC_500DP_PRO)
const uint16 g_bys_model_dev_type = 0x0001u;
const char   g_bys_model_name[]   = "BTC500DP_PRO";
const uint8  g_bys_model_name_len = sizeof(g_bys_model_name) - 1;
#elif (BTC_500DP_MODEL == BTC_500DP_MAX)
const uint16 g_bys_model_dev_type = 0x0003u;
const char   g_bys_model_name[]   = "BTC500DP_MAX";
const uint8  g_bys_model_name_len = sizeof(g_bys_model_name) - 1;
#else
#error "Invalid BTC_500DP_MODEL"
#endif
