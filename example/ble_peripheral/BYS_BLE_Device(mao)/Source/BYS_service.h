...
extern bStatus_t BYS_BLE_SERVICE_AddService( bleuart_ProfileChangeCB_t cb);
...
extern bStatus_t bleuart_Notify(attHandleValueNoti_t* pNoti, uint8 taskId );
