//BYS_BLE_APP
#ifndef _BYS_BLE_APP_H
#define _BYS_BLE_APP_H
...
#define BYS_BLE_Device_DEFType          		0x0001			//本机默认设备类型
...
extern BYS_Device_Data_t Dev_Data;
/*-----------------------------------------------------------------------------------------------------------------*/
extern void BYS_BLE_APP_Init(unsigned char taskId);
extern unsigned short BYS_BLE_APP_ProcessEvent(unsigned char task_id, unsigned short events);
