...
#ifndef _BYS_BLE_Service_H
#define _BYS_BLE_Service_H
...
typedef void (*bleuart_ProfileChangeCB_t)(BLE_Evt_t* pev);
...
extern unsigned char BYS_BLE_Service_AddService( bleuart_ProfileChangeCB_t cb);




extern unsigned char BYS_BLE_Service_NotifyIsReady(void);

extern unsigned char BYS_BLE_Service_Notify(unsigned char *Dat,unsigned short Len);//蓝牙服务发送数据
extern void BYS_BLE_Service_set_Notify(void);
extern void BYS_BLE_Service_clear_Notify(void);
