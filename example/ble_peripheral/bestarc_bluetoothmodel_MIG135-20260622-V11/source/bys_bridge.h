...
/* ─── 参数配置 ──────────────────────────────────── */
#define BYS_POLL_INTERVAL_MS    100u      /* 轮询包之间的间隔(ms) */
...
#define ADV_WIRE_DIAMETER_OFFSET   20
#define ADV_MIG_CURRENT_OFFSET     22
#define ADV_T2T4_OFFSET            24
#define ADV_ALARM_OFFSET           26
#define ADV_INPUT_VOLTAGE_OFFSET   28
