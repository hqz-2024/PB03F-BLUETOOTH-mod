...
/*********************************************************************
    GLOBAL VARIABLES
*/
#define I2C_DEMO    (0x01)
#define I2C_DMA     (0x02)
#define I2C_SOFT    (0x03)
...
{
    LL_ProcessEvent,
    #if (DEF_I2C_MOD==I2C_DEMO)
    I2c_ProcessEvent,
    #endif
    #if (DEF_I2C_MOD==I2C_DMA)
    I2c_Dma_ProcessEvent,
    #endif
    #if (DEF_I2C_MOD==I2C_SOFT)
    I2c_Soft_ProcessEvent,
    #endif
    #if (DEF_I2C_MOD==I2C_SLAVE)
    I2c_slave_ProcessEvent,
    #endif
};
